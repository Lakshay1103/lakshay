    ...
    return (
        ...
        >
            ...
            <div className='flex flex-col items-center justify-center h-screen'>
                ...
                <div className='hero-title text-white text-lg md:text-[50px] text-center font-extrabold' data-aos="fade-up" data-aos-duration="2000">Transforming Health and Wellness space for</div>
