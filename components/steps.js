...
const steps = () => {
    return (
        ...
        >
            ...
            <div className=' text-white text-[52px] text-center font-normal mt-24'>Our <span className='text-[#32CD32]'>3-Step System</span> for Seamless <br /> Social Media Growth</div>
